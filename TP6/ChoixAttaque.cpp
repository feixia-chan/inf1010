...
ChoixAttaque::ChoixAttaque(QWidget *parent) : QWidget(parent)
{
    ...
    //!!!!!! A COMPLETER !!!!!!
    QGridLayout *grille = new QGridLayout(parent);
    grille->addWidget(attaque1_,0,0);
    grille->addWidget(attaque2_,0,1);
    grille->addWidget(attaque3_,1,0);
    grille->addWidget(attaque4_,1,1);
