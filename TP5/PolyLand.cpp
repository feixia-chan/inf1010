...
{
    sort(poly.listMaitre_.begin(),poly.listMaitre_.end(),FoncteurComparerDresseurs());    //on trie les dresseurs
    sort(poly.listCompagnon_.begin(),poly.listCompagnon_.end(),FoncteurComparerCreatures()); //on trie les créatures
